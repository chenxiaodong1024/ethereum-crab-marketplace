                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        />
                        <span className="text-sm text-gray-300">{(filters.minPrice ?? 0).toFixed(3)} USDC</span>
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          className="w-full h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer"
                        />
                        <span className="text-sm text-gray-300">{(filters.maxPrice ?? 100).toFixed(3)} USDC</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center bg-blue-900/30 text-blue-300 text-sm rounded-full px-3 py-1 max-w-fit">
                        <span>{t('products.filters.price')}: {(filters.minPrice ?? 0).toFixed(3)} - {(filters.maxPrice ?? 100).toFixed(3)} USDC</span>
                      </div>
                    </div>
                  </div>
                </div>
